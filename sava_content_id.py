# GENERATED — do not edit; run scripts/build_sava_content_id.py
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        sys.stderr.write("usage: sava_content_id.py <drop-or-head.json>\n")
        sys.exit(1)
    with open(sys.argv[1], "r", encoding="utf-8") as f:
        obj = json.load(f)
    print(hashlib.sha256(dumps(obj["content"])).hexdigest())
